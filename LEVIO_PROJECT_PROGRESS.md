...
Статус: Stage 13.3 Closed Beta Operating Model & Support Boundaries завершен
как documentation-only operating model and support boundary definition.
Прогресс: ██░░░░░░░░ 20%.
...
Следующий bounded subblock: Stage 13.4 Closed Beta Test Scenarios & Success
Criteria. Он должен оставаться documentation-only до отдельного approval.
...
The next bounded subblock is Stage 13.4 Closed Beta Test Scenarios & Success
Criteria. It must remain documentation-only until separately approved and must
not open beta execution, runtime, UI, API, legal, data, commercial, analytics,
