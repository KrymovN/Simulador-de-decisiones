...
check("Stage 9 continuation remains planning only", currentCanonicalState.includes("Stage 9 Reinforced AI Review Batch 3 of 3 and Final Cross-Batch Adjudication") && currentCanonicalState.includes("next planning candidate") && !currentCanonicalState.includes("Batch 3 was executed"));
check("Dataset minimum reached with independent AI review in progress", currentCanonicalState.includes("216/216") && currentCanonicalState.includes("49/73") && currentCanonicalState.includes("24") && currentCanonicalState.includes("release readiness is not declared"));
...
check("Final cleanup diff stays inside the approved file set", actual.every((path) => allowed.has(path) || path.startsWith("docs/qa/review/ai-reinforced-batches/batch-1/") || path.startsWith("docs/qa/review/ai-reinforced-batches/batch-2/") || ["docs/qa/LEVIO_STAGE_9_REINFORCED_AI_REVIEW_METHODOLOGY.md", "docs/qa/review/AI_REINFORCED_REVIEW_PROGRESS.json", "docs/qa/review/AI_REVIEW_CONSOLIDATED_ISSUE_DISPOSITIONS.json", "docs/qa/review/AI_REVIEW_CALIBRATION_ASSESSMENT.json", "scripts/generate-stage-9-reinforced-ai-review-batch-1.mjs", "scripts/stage-9-reinforced-ai-review-batch-1-quality.mjs", "scripts/generate-stage-9-reinforced-ai-review-batch-2.mjs", "scripts/stage-9-reinforced-ai-review-batch-2-quality.mjs"].includes(path)), `Unexpected files: ${actual.filter((path) => !allowed.has(path)).join(", ")}`);
...
check("Reconciliation changes no visual application or UI file", reconciliationDiff.every((path) => reconciliationAllowed.has(path) || path.startsWith("docs/qa/review/ai-reinforced-batches/batch-1/") || path.startsWith("docs/qa/review/ai-reinforced-batches/batch-2/") || ["docs/qa/LEVIO_STAGE_9_REINFORCED_AI_REVIEW_METHODOLOGY.md", "docs/qa/review/AI_REINFORCED_REVIEW_PROGRESS.json", "docs/qa/review/AI_REVIEW_CONSOLIDATED_ISSUE_DISPOSITIONS.json", "docs/qa/review/AI_REVIEW_CALIBRATION_ASSESSMENT.json", "scripts/generate-stage-9-reinforced-ai-review-batch-1.mjs", "scripts/stage-9-reinforced-ai-review-batch-1-quality.mjs", "scripts/generate-stage-9-reinforced-ai-review-batch-2.mjs", "scripts/stage-9-reinforced-ai-review-batch-2-quality.mjs"].includes(path)), `Unexpected current reconciliation files: ${reconciliationDiff.filter((path) => !reconciliationAllowed.has(path)).join(", ")}`);
