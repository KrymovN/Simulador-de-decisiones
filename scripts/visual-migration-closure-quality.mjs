...
check("Stage 9 continuation remains planning only", currentCanonicalState.includes("Stage 9 Schema-Oracle Evidence Projection Revision") && currentCanonicalState.includes("implementation-ready candidate") && currentCanonicalState.includes("not implemented"));
check("Dataset review complete with remediation unstarted", currentCanonicalState.includes("216/216") && currentCanonicalState.includes("73/73") && currentCanonicalState.includes("fixture remediation") && currentCanonicalState.includes("`NONE`") && currentCanonicalState.includes("release readiness is not declared"));
...
check("Final cleanup diff stays inside the approved file set", actual.every((path) => allowed.has(path) || path.startsWith("docs/qa/review/ai-reinforced-batches/batch-1/") || path.startsWith("docs/qa/review/ai-reinforced-batches/batch-2/") || path.startsWith("docs/qa/review/ai-reinforced-batches/batch-3/") || path.startsWith("docs/qa/remediation/stage-9/") || ["docs/qa/LEVIO_STAGE_9_REINFORCED_AI_REVIEW_METHODOLOGY.md", "docs/qa/review/AI_REINFORCED_REVIEW_PROGRESS.json", "docs/qa/review/AI_REINFORCED_REVIEW_CLOSURE.json", "docs/qa/review/AI_REVIEW_CONSOLIDATED_ISSUE_DISPOSITIONS.json", "docs/qa/review/AI_REVIEW_CALIBRATION_ASSESSMENT.json", "docs/qa/review/AI_REVIEW_FINAL_CALIBRATION_ASSESSMENT.json", "docs/qa/review/AI_REVIEW_FINAL_CROSS_BATCH_ADJUDICATION.json", "docs/qa/review/AI_REVIEW_FINAL_PATTERN_ADJUDICATION.json", "docs/qa/review/AI_REVIEW_REMEDIATION_CANDIDATE_REGISTRY.json", "scripts/generate-stage-9-reinforced-ai-review-batch-1.mjs", "scripts/stage-9-reinforced-ai-review-batch-1-quality.mjs", "scripts/generate-stage-9-reinforced-ai-review-batch-2.mjs", "scripts/stage-9-reinforced-ai-review-batch-2-quality.mjs", "scripts/generate-stage-9-reinforced-ai-review-batch-3.mjs", "scripts/stage-9-reinforced-ai-review-batch-3-quality.mjs", "scripts/stage-9-remediation-plan-quality.mjs"].includes(path)), `Unexpected files: ${actual.filter((path) => !allowed.has(path) && !path.startsWith("docs/qa/remediation/stage-9/")).join(", ")}`);
...
check("Reconciliation changes no visual application or UI file", reconciliationDiff.every((path) => reconciliationAllowed.has(path) || path.startsWith("docs/qa/review/ai-reinforced-batches/batch-1/") || path.startsWith("docs/qa/review/ai-reinforced-batches/batch-2/") || path.startsWith("docs/qa/review/ai-reinforced-batches/batch-3/") || ["docs/qa/LEVIO_STAGE_9_REINFORCED_AI_REVIEW_METHODOLOGY.md", "docs/qa/review/AI_REINFORCED_REVIEW_PROGRESS.json", "docs/qa/review/AI_REINFORCED_REVIEW_CLOSURE.json", "docs/qa/review/AI_REVIEW_CONSOLIDATED_ISSUE_DISPOSITIONS.json", "docs/qa/review/AI_REVIEW_CALIBRATION_ASSESSMENT.json", "docs/qa/review/AI_REVIEW_FINAL_CALIBRATION_ASSESSMENT.json", "docs/qa/review/AI_REVIEW_FINAL_CROSS_BATCH_ADJUDICATION.json", "docs/qa/review/AI_REVIEW_FINAL_PATTERN_ADJUDICATION.json", "docs/qa/review/AI_REVIEW_REMEDIATION_CANDIDATE_REGISTRY.json", "scripts/generate-stage-9-reinforced-ai-review-batch-1.mjs", "scripts/stage-9-reinforced-ai-review-batch-1-quality.mjs", "scripts/generate-stage-9-reinforced-ai-review-batch-2.mjs", "scripts/stage-9-reinforced-ai-review-batch-2-quality.mjs", "scripts/generate-stage-9-reinforced-ai-review-batch-3.mjs", "scripts/stage-9-reinforced-ai-review-batch-3-quality.mjs", "scripts/stage-9-remediation-plan-quality.mjs"].includes(path)), `Unexpected current reconciliation files: ${reconciliationDiff.filter((path) => !reconciliationAllowed.has(path)).join(", ")}`);
