...
add("evaluation-specific-output-budget", evaluation.CANONICAL_PROVIDER_EVALUATION_LIMITS.maxOutputTokens === 4000 && evaluation.CANONICAL_PROVIDER_EVALUATION_LIMITS.maxCostUsd === 0.06, "Evaluation-only output and conservative cost ceilings must be 4000 tokens and $0.06.");
