...
const SCENARIO_BLUEPRINTS: ScenarioBlueprint[] = [
  ...
  scenario("study_abroad_trial", "education", "strategic_direction", { es: "Una estudiante ficticia compara un semestre internacional, un programa local y una estancia académica breve de prueba que permite volver a la opción anterior.", en: "A fictional student compares a semester abroad, a local program, and a short reversible trial.", ru: "Вымышленный студент сравнивает семестр за рубежом, местную программу и короткий пробный учебный период с возможностью вернуться к прежнему варианту.", zh: "一名虚构学生比较海外学期、本地项目和保留回到原方案选择的短期试学。" }, ["program_dates_known"], ["credit_transfer_approved"], ["transfer_confirmation"], ["credit_loss", "housing_dependency"], { privacy_boundary: true }),
  ...
  scenario("trial_city", "relocation_and_housing", "strategic_direction", { es: "Una persona ficticia compara quedarse, mudarse o probar otra ciudad durante tres meses.", en: "A fictional person compares staying, moving, or trying another city for three months.", ru: "Вымышленный человек сравнивает остаться, переехать или попробовать другой город на три месяца.", zh: "一个虚构的人比较留下、搬迁或在另一座城市试住三个月。" }, ["trial_budget_known"], ["remote_work_continues"], ["return_housing_option"], ["return_housing_option_uncertainty", "reversibility_loss"]),
