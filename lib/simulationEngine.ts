...
const thinkingStages: ThinkingStage[] = [
  ...
  {
    title: "Preparando conclusión estratégica",
    detail: "Construyendo una recomendación accionable sin presentar una certeza falsa.",
  },
];
  ...
  return [
    {
      ...
      recommendation: "Actúa en pequeño, mide pronto y escala solo con señales reales.",
    },
    {
      ...
      recommendation: "Reduce velocidad hasta tener una condición objetiva de avance.",
    },
    {
      ...
      recommendation: "Programa una revisión obligatoria antes de que la inercia decida por ti.",
    },
    {
      ...
      recommendation: "Define una prueba de 14 a 30 días con umbral claro de continuidad.",
    },
  ];
}
...
export function buildMockSimulation(input: string): SimulationResponse {
  ...
  const strategicConclusion = `La mejor ruta no es decidir de golpe, sino convertir "${normalizedInput}" en una prueba reversible con límites, señales de avance y una revisión en ${latency}.`;
    ...
    simulation: {
      ...
      impacts: [
        ...
        },
        {
          ...
          value: advantage,
          copy: "La ruta recomendada preserva aprendizaje, reputación y capacidad de ajustar el rumbo.",
        },
      ],
      timeline: [
        {
