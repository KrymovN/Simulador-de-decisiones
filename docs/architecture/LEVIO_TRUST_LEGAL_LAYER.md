...
`../qa/LEVIO_EVALUATION_DATASET_QUALITY_THRESHOLDS.md` defines semantic quality thresholds and human review.
...
`../qa/LEVIO_TESTING_STRATEGY.md` defines deterministic proof and release gates.
