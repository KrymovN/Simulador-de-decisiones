...
- Product UI follows `../architecture/LEVIO_MULTILINGUAL_ARCHITECTURE.md`.
...
- `../archive/handoffs/PROJECT_CONTEXT_LEVIO.md`
- `../architecture/VISUAL_ENGINE_PLAN.md`
- `../../README.md`
- `../../AGENTS.md`
- `../../CLAUDE.md`
...
3. `../architecture/VISUAL_ENGINE_PLAN.md`, a historical project-level architecture research document, was written primarily in Russian.
4. `../architecture/LEVIO_MULTILINGUAL_ARCHITECTURE.md` used a Russian-language native label for Russian inside otherwise English documentation.
...
- `../architecture/VISUAL_ENGINE_PLAN.md` was translated into English while preserving its research-only status, risk conclusions, staged approach, and prohibition on immediate production WebGL integration.
- The Russian language label in `../architecture/LEVIO_MULTILINGUAL_ARCHITECTURE.md` was changed to its English documentation label.
