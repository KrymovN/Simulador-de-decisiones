...
Controls owner-scoped simulation draft export inclusion. The
...
**50% estimated**. The Stage 7 retention planning/status surface is
...
eligible owner-scoped simulation draft inclusion in account export inside the
existing export/delete/retention scope. Draft reads use canonical principal
preflight and do not expose owner/provider authority or open destructive
lifecycle behavior.
