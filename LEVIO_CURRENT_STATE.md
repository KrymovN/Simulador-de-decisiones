...
This document reflects the local project state in `/Users/s3/Documents/New project` after Stage 2.20 Production Trust / Legal Layer. It is the primary current handoff file. `PROJECT_CONTEXT.md` must remain synchronized with it.
